...
export default async function Page({ params }: { params: Promise<{ token: string }> }) {
  ...
  return (
    <main style={{ fontFamily: "system-ui", padding: 24, maxWidth: 720 }}>
      <h1>Пачка роликов</h1>
      <p>
        Сверху — все подложки одним пулом: бот раздаст их хукам по кругу и перемешает порядок
        публикации. Ниже — группы: список хуков и одно описание на всю группу. Каждый хук
        становится отдельным роликом.
      </p>
